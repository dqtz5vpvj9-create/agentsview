...
scoped to their own sessions. Counts come from the filtered message data, independently of
...
matching disclosure is opened automatically. Skim layout temporarily lifts
while searching without changing the saved layout preference. Native CSS highlights do not rewrite transcript text. Precise
